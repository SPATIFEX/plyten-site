...
Stage-0 placeholder for **plyten.com** — plain HTML and CSS, published straight from
...
| `CNAME` | `plyten.com` — read by GitHub Pages, inert until DNS points here |
...
The reviewed Astro starter imported into this repository as `df73aca` is
